...
@Component
public class GitPullTool implements Tool {
    ...
    public ToolResult execute(ToolContext context) {
        ...
        try {
            ...
            return new ToolResult(ToolResult.ExecutionStatus.FAILURE, null, "Failed to execute git pull: " + e.getMessage(), Duration.between(start, Instant.now()), -1);
        }
    }
}
